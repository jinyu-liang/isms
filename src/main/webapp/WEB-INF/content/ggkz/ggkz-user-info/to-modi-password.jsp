	...
	<body>
		<div class="page unitBox" >
			...
			<div class="pageContent">
				<s:form method="post" action="ggkz/ggkz-user-info!modiPassword.action"  cssClass="pageForm" onsubmit="return validateCallback(this,closeAndRefresh);" id="%{_}">
					<div class="pageFormContent col1" layoutH="56">
						<div>
							<label for="oldPassword">请输入原密码</label>
							<span>
								<s:password name="entity.password" id="oldPassword"></s:password>
						  	</span>
						</div>
						<div>
