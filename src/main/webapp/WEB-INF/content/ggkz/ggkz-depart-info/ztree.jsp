...
var msgInteractRemind="1";
	...
	<!--  <script type="text/javascript" src="${basePath}ISMS/js/jquery.ztree.excheck.js"></script>
	  <script type="text/javascript" src="${basePath}ISMS/js/ztree/jquery.ztree.exedit.js"></script>-->
	<SCRIPT type="text/javascript">
		<!--
		var setting = {
			data: {
