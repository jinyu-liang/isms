...
<body>
    <div class="page" id="${_}">
        ...
        <div class="pageContent">
            <s:form method="post"  callback="closeAndRefresh(this)" cssClass="pageForm" onsubmit="return validateCallback(this,closeAndRefresh);">
                <div>
                     <ul id="${_}myGallery">
    ...
    <script type="text/javascript">
		...
		$("#${_}myGallery").ready(function(){
			$('#${_}myGallery').galleryView({
				...
				panel_height: 650, 				//INT - height of gallery panel (in pixels)
