...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>工地设备明细查看</title>
	</head>
	<body>
			<div class="page">
				<s:property value="message" escapeHtml="false"/>
				<div class="pageContent">
						<s:form method="post" action="mWorkshopItem!toEdit" cssClass="pageForm" onsubmit="return pageSubmit(this);">
							<div>
								...
								<s:hidden name="entity.itemId" value="%{entity.itemId}" />
									...
									<table class="list" width="100%">
											...
											<tr>
													...
													<td><span>
																<s:property value="entity.remainNumber" /></br>
