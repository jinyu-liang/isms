...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>编辑dRecordUserMapping</title>
	</head>
	<body>
			  <div class="page">
						<s:property value="message" escapeHtml="false"/>
							 <div class="pageContent">
									 <s:form method="post" action="dRecordUserMapping!edit" callback="closeAndRefresh(this)" cssClass="pageForm" onsubmit="return pageSubmit(this);">
