...
<!-- <p > -->
    <table id="mytable" cellspacing="0">
            <tr>
                ...
                <td scope="col"><s:property value="entity.workCenterId"/></td>
                <td scope="col"><font style="font-weight:bold;">订单号:</font></td>
                <td scope="col"><s:property value="entity.teamCd"/></td>
                <td scope="col"><font style="font-weight:bold;">带队人员:</font></td>
                <td scope="col"><s:property value="entity.reportUserName"/></td>
                <td scope="col"><font style="font-weight:bold;">联系电话:</font></td>
                <td scope="col"><s:property value="entity.reportUserTel" /></td>
            </tr>
    </table>
