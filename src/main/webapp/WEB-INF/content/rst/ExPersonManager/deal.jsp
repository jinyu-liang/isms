...
<body>
    <div class="page unitBox" style="width: 100%;height: 100%;overflow: hidden;">
        <s:property value="message" escapeHtml="false" />
        <div class="pageContent" style="width: 100%;height: 100%;overflow: hidden;">
            <s:form method="post" action="ex-person-manager!deal" cssClass="pageForm" cssStyle="width: 100%;height: 100%;overflow: hidden;"
                onsubmit="return validateCallback(this,$.pdialog.closeCurrentRefresh);" id="%{_}">
                <s:hidden name="queryEntity.reportId"></s:hidden>
                <div class="pageFormContent" layoutH="58" style="overflow: hidden; width: 100%;">
	                <!-- <div class="pageFormContent"    style="float: left;height:450px; width: 800px;  "> -->
	                    <s:include value="_edit_deal.jsp" />
	                <!-- </div> -->
		...
		$("#${_} #${_}myGallery").ready(function() {
			$('#${_} #${_}myGallery').galleryView({
				...
				panel_width : 470, //INT - width of gallery panel (in pixels)
