			  ...
			  <div class="page">
						<s:property value="message" escapeHtml="false"/>
							 <div class="pageContent">
									 <s:form method="post" action="ex-person-info-pay!Update" callback="closeAndRefresh(this)" cssClass="pageForm" onsubmit="return validateCallback(this,$.pdialog.closeCurrentRefresh);" id="%{_}">
										
										   <div class="pageFormContent col1" layoutH="56">
													<s:hidden name="entity.pid" value="%{entity.pid}" />
