...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>编辑工地人员信息表</title>
	</head>
	<body>
			  <div class="page">
						<s:property value="message" escapeHtml="false"/>
							 <div class="pageContent">
									 <s:form method="post" action="ex-person-info!edit" callback="closeAndRefresh(this)" cssClass="pageForm" onsubmit="return validateCallback(this,$.pdialog.closeCurrentRefresh);" id="%{_}">
