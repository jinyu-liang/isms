...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>编辑上传大小控制表</title>
	</head>
	<body>
			  <div class="page">
						<s:property value="message" escapeHtml="false"/>
							 <div class="pageContent">
									 <s:form method="post" action="rst-upload-conf!edit"  cssClass="pageForm" onsubmit="return validateCallback(this,$.pdialog.closeCurrentRefresh);" >
