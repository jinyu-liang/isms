...
<body>
    <div class="page">
        ...
        <div class="pageContent">
            <s:form method="post" action="d-scrap-trans!affirmDelivery"  cssClass="pageForm" onsubmit="return validateCallback(this,$.pdialog.closeCurrentRefresh);" id="%{_}">
                ...
                <div class="formBar">
                    <ul>
                        <sec:authorize ifAllGranted="剩料管理-确认收货">
                        <li>
                                <s:if test='sessionUser.username!=entity.receiver||entity.statusCd!="0"'>
                                    ...
                                    <div class="button">
                                        <div class="buttonContent">
                                            <button type="button"
                                            onclick="affirmDelivery()">确定</button>
                                        </div>
                                     </div>
                                </s:else>
                        </li>
