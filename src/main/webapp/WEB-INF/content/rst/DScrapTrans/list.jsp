...
<body>
	...
	<s:form method="post" action="d-scrap-trans!list"
						...
						<tbody>
							<s:iterator value="page.data">
								<tr target="entity_transId" rel='<s:property value="transId" />'>
									<td><sec:authorize ifAllGranted="剩料管理-查看剩料信息">
											<s:a id="showView" namespace="/rst" action="d-scrap-trans"
									...
									<td><s:date name="arrivalTm" format="yyyy-MM-dd HH:mm:ss" />
									 ...
									 <td title="<s:property value="memo" />"><div class="autocut"><s:property value="memo" /></div>
									</td>
                                    <s:if test="sessionUser.userId=='USER0047'">
                                        <td><s:a style="cursor:pointer" namespace="/rst" action="d-scrap-trans" method="deleteScrapTrans" title="是否删除本条剩料信息?"
