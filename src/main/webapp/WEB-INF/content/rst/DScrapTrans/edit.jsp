...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>编辑dScrapTrans</title>
	</head>
	<body>
			  <div class="page">
						<s:property value="message" escapeHtml="false"/>
							 <div class="pageContent">
									 <s:form method="post" action="dScrapTrans!edit" callback="closeAndRefresh(this)" cssClass="pageForm" onsubmit="return pageSubmit(this);">
										
										   <div class="pageFormContent col1" layoutH="56">
													<s:hidden name="entity.transId" value="%{entity.transId}" />
