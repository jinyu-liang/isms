...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<title>dScrapTransImage列表</title>
    </head>
    <body>
		<s:property value="message" escapeHtml="false"/>
		<s:form method="post" action="dScrapTransImage!list" cssStyle="height:100%;width:100%;" onsubmit="return navTabSearch(this);" id="%{_}">
														...
														<ul class="searchContent">
																				...
																				<li>
																						...
																						<label for="entity_transId">运输Id</label>
																							<s:textfield id="queryEntity_transId" name="queryEntity.transId" maxLength="32"/>
																				...
																				<li>
																						...
																						<label for="entity_checkBy">验货人</label>
																							<s:textfield id="queryEntity_checkBy" name="queryEntity.checkBy" maxLength="32"/>
										...
										<tbody>
											<s:iterator value="page.data">
												<tr key="entity.photoId" value='<s:property value="photoId" />'>
													...
													<td><s:property value="checkBy" /></td>
												</tr>
											</s:iterator>
										</tbody>
									</table>
