...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>dScrapTransImage查看</title>
	</head>
	<body>
			<div class="page">
				<s:property value="message" escapeHtml="false"/>
				<div class="pageContent">
						<s:form method="post" action="dScrapTransImage!toEdit" cssClass="pageForm" onsubmit="return navTabSearch(this);">
							<div>
								...
								<s:hidden name="entity.photoId" value="%{entity.photoId}" />
									...
									<table class="list" width="100%">
											...
											<tr>
													<td><label>验货人</label></td>	
													<td><span>
																<s:property value="entity.checkBy" /></br>
