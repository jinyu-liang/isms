...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>dDeliveryItem查看</title>
	</head>
	<body>
			<div class="page">
				<s:property value="message" escapeHtml="false"/>
				<div class="pageContent">
						<s:form method="post" action="dDeliveryItem!toEdit" cssClass="pageForm" onsubmit="return navTabSearch(this);">
							<div>
								...
								<s:hidden name="entity.itemId" value="%{entity.itemId}" />
									...
									<table class="list" width="100%">
											...
											<tr>
													<td><label>货物类别代码-备用</label></td>	
													<td><span>
																<s:property value="entity.classCd" /></br>
											...
											<tr>
													<td><label>货物类别名称</label></td>	
													<td><span>
																<s:property value="entity.classNm" /></br>
											...
											<tr>
													<td><label>标识名称</label></td>	
													<td><span>
																<s:property value="entity.identificationNm" /></br>
