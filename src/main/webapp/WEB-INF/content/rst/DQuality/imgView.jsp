...
<body>
	<div class="page">
		...
		<div class="formBar">
			...
			<s:form method="post" action="d-report!toEdit" cssClass="pageForm"
		...
		$("#${_}myGallery").ready(function() {
			$('#${_}myGallery').galleryView({
				...
				panel_width : 975, //INT - width of gallery panel (in pixels)
				panel_height : 655, //INT - height of gallery panel (in pixels)
