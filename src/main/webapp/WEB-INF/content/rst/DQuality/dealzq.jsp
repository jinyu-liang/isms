...
<body>
	<div class="page unitBox" >
		...
		<div class="pageContent">
			<s:form method="post" action="d-quality!billDealzq" cssClass="pageForm"
				onsubmit="return validateCallback(this,closeAndRefresh);" id="%{_}">
				<s:hidden name="entity.pid"></s:hidden>
				<s:hidden name="entity.fqstatus"></s:hidden>
				<div>
					<div class="pageFormContent" layoutH="56"
						style="float: left; width: 500px;">
						<s:include value="_edit_dealzq.jsp" />
					</div>
					<div style="float: right; width: 475px;">
						<ul id="${_}myGallery">
							<s:if test="imageList!=null&imageList.size()>0">
				...
				<div class="formBar">
					<ul>
						<s:if test="()entity.fqstatus==\"1\ or entity.fqstatus==\"2\ )and entity.zguserid != null and entity.zguserid.toString().indexOf(sessionUser.userId.toString())>=0">
						<li>
							<div class="buttonActive">
								<div class="buttonContent">
									<s:if test="entity.fqstatus==\"1\"">
									<s:submit type="button" value="整改确认" />
									</s:if>
									<s:if test="entity.fqstatus==\"2\"">
									<s:submit type="button" value="整改完成确认" />
									</s:if>
								</div>
							</div></li>
						<li>
