...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>添加dProgressReport</title>
	</head>
	<body>
			<s:property value="message" escapeHtml="false"/>
			<div class="page">
					<div class="pageContent">
							<s:form method="post" action="dProgressReport!create" callback="closeAndRefresh(this)" cssClass="pageForm" onsubmit="return pageSubmit(this);">
