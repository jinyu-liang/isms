...
<body>
    <s:form method="post" namespace="/msg" action="msg-interact!toSend.action" onsubmit="return navTabSearch(this);"
                ...
                <div region="north" height="66">
                    <div class="pageHeader">
                        <div class="searchBar" style="height: 26px;">
                            <font style="line-height: 26px;">发件箱 (共 <s:property value="page.count" /> 封)
                            </font>
                        </div>
                    </div>
                        ...
                        <div class="panelBar">
                            <ul class="toolBar">
                                ...
                                <s:a id="%{_}view" namespace="/msg" action="msg-interact" method="viewMsg" encode="false" cssStyle="display:none;" target="ajax"
                                    ...
                                    <s:param name="msgbox" value="'send'" />
                                </s:a>
