...
<body>
    <s:form method="post" namespace="/msg" action="msg-interact!toGarbage.action" onsubmit="return navTabSearch(this);" cssStyle="height:100%;width:100%;" id="%{_}">
        <div class="page" style="height: 100%; width: 100%;">
            <div class="layout">
                <div region="north" height="66">
                    <div class="pageHeader">
                        <div class="searchBar" style="height: 26px;">
                                <font style="line-height: 26px;">垃圾箱 (共 <s:property value="page.count" /> 封)</font>
                        </div>
                    </div>
                        ...
                        <div class="panelBar">
                            <ul class="toolBar">
                                <li><s:a namespace="/msg" action="msg-interact" method="deleteMsg" encode="false" title="确实要删除这些记录吗?"
                                        ...
                                        rel="ids" mask="true">
                                        <s:param name="msgbox" value="'garbage'"></s:param>
                                        <span>删除</span>
                                    </s:a></li>
                                <%-- <li><s:a namespace="/msg" action="msg-interact" method="toForwardSend" encode="false" cssClass="delete"
                                ...
                                <s:a id="%{_}view" namespace="/msg" action="msg-interact" method="viewMsg" encode="false" cssStyle="display:none;" target="ajax"
                                    rel="mainmsg">
                                    <s:param name="entity.id" value="'{list_data_gerbageMsgId}'" />
                                    <s:param name="msgbox" value="'garbage'" />
                                    <span>查看</span>
                                </s:a>
                    ...
                    <table class="table">
                        ...
                        <tbody ondblclick="$('#${_}view').click();">
                            <s:iterator value="page.data" var="msg">
                                <tr target="list_data_gerbageMsgId" rel='<s:property value="id" />'>
