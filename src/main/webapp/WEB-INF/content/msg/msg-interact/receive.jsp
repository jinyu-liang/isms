...
<body>
    <s:form method="post" namespace="/msg" action="msg-interact!toReceived.action" onsubmit="return navTabSearch(this);"
            ...
            <div class="layout">
                <div region="north" height="66">
                    <div class="pageHeader">
                        <div class="searchBar" style="height: 26px;">
                            <font style="line-height: 26px;">收件箱 (共 <s:property value="page.count" /> 封，其中 未读邮件 <s:property
                                    value="unreadcount" /> 封)
                            </font>
                        </div>
                    </div>
                    <div class="pageContent">
                        <div class="panelBar">
                            <ul class="toolBar">
                                <li><s:a namespace="/msg" action="msg-interact" method="toForwardSend" encode="false" cssClass="edit"
                                        target="ajax" rel="mainmsg">
                                        <s:param name="ids" value="'{list_data_receiveMsgId}'" />
                                        <s:param name="msgbox" value="'receive'"></s:param>
                                        <s:param name="forwardTp" value="0"></s:param>
                                        <span>回复</span>
                                    </s:a></li>
                                <li><s:a namespace="/msg" action="msg-interact" method="toForwardSend" encode="false" cssClass="edit"
                                        target="ajax" rel="mainmsg">
                                        <s:param name="ids" value="'{list_data_receiveMsgId}'" />
                                        <s:param name="msgbox" value="'receive'"></s:param>
                                        <s:param name="forwardTp" value="1"></s:param>
                                        <span>回复全部</span>
                                    </s:a></li>
                                <li><s:a namespace="/msg" action="msg-interact" method="toForwardSend" encode="false" cssClass="edit"
                                        target="selectedTodo" rel="ids" fill="mainmsg">
                                        <s:param name="msgbox" value="'receive'"></s:param>
                                        <span>转发</span>
                                    </s:a></li>
                                ...
                                <s:a id="%{_}view" namespace="/msg" action="msg-interact" method="viewMsg" encode="false" cssStyle="display:none;"
                                    target="ajax" rel="mainmsg">
                                    <s:param name="entity.id" value="'{list_data_receiveMsgId}'" />
                                    <s:param name="msgbox" value="'receive'" />
                                    <span>查看</span>
                                </s:a>
                    ...
                    <table class="table">
                        ...
                        <tbody ondblclick="$('#${_}view').click();">
                            <s:iterator value="page.data" var="msg">
                                <tr target="list_data_receiveMsgId" rel='<s:property value="id" />'>
                ...
                <div region="south" height="26">
                    <div class="panelBar">
                        ...
                        <div class="pagination" targetType="ajax" rel="mainmsg" totalCount='<s:property value="page.count"/>'
                            numPerPage='<s:property value="page.pageSize"/>' pageNumShown='<s:property value="page.pageNumShown"/>'
