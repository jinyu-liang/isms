...
public class SSLConfig
{
    ...
    static
    {
        ...
        storeType = SystemPropertiesUtil.getStringPropertie("xmpp.ssl.storeType", "JKS");
        keyStoreLocation = SystemPropertiesUtil.getStringPropertie("xmpp.ssl.keystore", "conf" + File.separator + "security" + File.separator
                + "keystore");
        keyStoreLocation = classPath.getPath() + File.separator + keyStoreLocation;
        keyPass = SystemPropertiesUtil.getStringPropertie("xmpp.ssl.keypass", "changeit");
        trustStoreLocation = SystemPropertiesUtil.getStringPropertie("xmpp.ssl.truststore", "conf" + File.separator + "security" + File.separator
                + "truststore");
        trustStoreLocation = classPath.getPath() + File.separator + trustStoreLocation;
        trustPass = SystemPropertiesUtil.getStringPropertie("xmpp.ssl.trustpass", "changeit");
        ...
        {
            log.debug("SSLConfig startup problem.\n" + "  storeType: [" + storeType + "]\n" + "  keyStoreLocation: [" + keyStoreLocation + "]\n"
                    + "  keyPass: [" + keyPass + "]", e);
            keyStore = null;
        }
        ...
        try
        {
            ...
            sslContext.init(keyFactory.getKeyManagers(), c2sTrustFactory.getTrustManagers(), new java.security.SecureRandom());

        }
        catch (Exception e)
        {
            log.debug("SSLConfig factory setup problem." + "  storeType: [" + storeType + "]\n" + "  keyStoreLocation: [" + keyStoreLocation + "]\n"
                    + "  keyPass: [" + keyPass + "]\n" + "  trustStoreLocation: [" + trustStoreLocation + "]\n" + "  trustPass: [" + trustPass + "]",
                    e);
            keyStore = null;
            trustStore = null;
