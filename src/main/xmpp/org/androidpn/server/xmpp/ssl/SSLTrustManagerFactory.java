...
public class SSLTrustManagerFactory
{
    ...
    public static TrustManager[] getTrustManagers(String storeType, String truststore, String trustpass) throws NoSuchAlgorithmException,
    ...
    public static TrustManager[] getTrustManagers(KeyStore truststore, String trustpass)
    {
        ...
        {
            trustManagers = null;
            log.debug("SSLTrustManagerFactory startup problem.", e);
        }
