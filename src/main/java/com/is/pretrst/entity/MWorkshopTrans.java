 ...
 *
 */
public class MWorkshopTrans extends AbstractBaseEntity
{
    ...
    private List<MTransItem>        itemList;
	...
	public List<MTransItem> getItemList() {
		return itemList;
	}

	public void setItemList(List<MTransItem> itemList) {
