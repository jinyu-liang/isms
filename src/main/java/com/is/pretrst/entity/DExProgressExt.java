 ...
 *
 */
public class DExProgressExt extends AbstractBaseEntity
{
    ...
    /* 关联对象 */
    private List<DExItemExt>         dexItemExt;
    ...
    public List<DExItemExt> getDexItemExt()
    {
        return dexItemExt;
    }
    public void setDexItemExt(List<DExItemExt> dexItemExt)
    {
        this.dexItemExt = dexItemExt;
    }
    ...
    {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("progressStatus", getProgressStatus())
                .append("fbWorkshop", getFbWorkshop()).append("fbDelivery", getFbDelivery()).append("fbQuality", getFbQuality())
                .append("fbSecurity", getFbSecurity()).append("fbManner", getFbManner()).append("fbMmaterial", getFbMmaterial())
                .append("fbSmaterial", getFbSmaterial()).append("fbEquipment", getFbEquipment()).append("totalCost", getTotalCost())
                .append("currentCost", getCurrentCost()).append("totalExpense", getTotalExpense()).append("currentExpense", getCurrentExpense())
                .append("teamLeader", getTeamLeader()).append("welder", getWelder()).append("riveter", getRiveter())
                .append("workerCount", getWorkerCount()).append("viceManager", getViceManager()).append("wsLeader", getWsLeader())
                .append("memo", getMemo())
                .append("dexItemExt",getDexItemExt())
