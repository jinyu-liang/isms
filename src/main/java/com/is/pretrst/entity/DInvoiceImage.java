 ...
 * @Description: DInvoiceImage表的对应的java对象，该文件为工具自动生成，请勿手工修改!
 * @author 
 * @date 2013-09-10 10:26:21
 *
 */
public class DInvoiceImage extends AbstractBaseEntity
{
    ...
    {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("photoId", getPhotoId()).append("invoiceId", getInvoiceId())
